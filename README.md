...
* **[colomr-v1-theme]** - Hugo theme built with Material Design 3 — dark/light mode, glassmorphism, block system, badge grid. Designed with Google Stitch 2.
* **[claude-config]** - configuración global de claude code: contrato de trabajo, política compartida y orquestador de sincronización
...
* **Google Skills** [Public Profile]([https://colomr.cc/](https://www.skills.google/public_profiles/36fdb0e1-891c-4dc5-aef1-d89aecc3dd45))
